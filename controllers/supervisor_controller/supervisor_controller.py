...
This controller randomizes block layouts of the field in order to provide robust testing of possible edge cases. This controller is not used in typical worlds where the Supervisor does not exist.
"""
...
if __name__ == '__main__':
    # commented lines below are configurations that the robot has failed in
    ...
    #get pointers to translation fields of blocks
    for i in range(1, 5):
    ...
    # retrieve randomized valid positions for blocks using a uniform distribution
    ...
    # set the block positions once and then allow simulation to run
    ...
    # print configuration in case the robot failed this configuration
    string = ''
